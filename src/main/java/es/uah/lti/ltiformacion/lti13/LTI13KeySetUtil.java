 ...
 */
package es.uah.lti.ltiformacion.lti13;
...
public class LTI13KeySetUtil {
	...
	public static JSONObject getKeySetJSON(Map<String, RSAPublicKey> keys)
	...
	public static JSONObject getKeySetJSON(String kid, RSAPublicKey key)
			throws java.security.NoSuchAlgorithmException {
	...
	public static JSONObject getKeySetJSON(RSAPublicKey key)
			throws java.security.NoSuchAlgorithmException {
		Map<String, RSAPublicKey> keys = new TreeMap<>();
	...
	public static RSAPublicKey getKeyFromKeySet(String kid, String url) 
		throws java.text.ParseException, com.nimbusds.jose.JOSEException, java.io.IOException
	{
